...
return (new CustomEvent(event_name,(function (){var obj34359 = {"detail":data};
return obj34359;
})()));
} else {
...
var f = (function (){var pred__34366 = cljs.core._EQ_;
var expr__34367 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34366.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34367))){
return ((function (pred__34366,expr__34367){
return (function (p1__34360_SHARP_){
return console.warn(p1__34360_SHARP_);
});
;})(pred__34366,expr__34367))
} else {
if(cljs.core.truth_(pred__34366.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34367))){
return ((function (pred__34366,expr__34367){
return (function (p1__34361_SHARP_){
return console.debug(p1__34361_SHARP_);
});
;})(pred__34366,expr__34367))
} else {
if(cljs.core.truth_(pred__34366.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34367))){
return ((function (pred__34366,expr__34367){
return (function (p1__34362_SHARP_){
return console.error(p1__34362_SHARP_);
});
;})(pred__34366,expr__34367))
} else {
return ((function (pred__34366,expr__34367){
return (function (p1__34363_SHARP_){
return console.log(p1__34363_SHARP_);
});
;})(pred__34366,expr__34367))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34370){
...
var eval_fn = cljs.core.get.call(null,map__34371__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34373_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__34375,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1521146646282
