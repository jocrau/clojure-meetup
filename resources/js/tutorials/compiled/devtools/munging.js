...
var o24320 = temp__5455__auto__;
var temp__5455__auto____$1 = (o24320["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o24321 = temp__5455__auto____$1;
return (o24321["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__23009__auto__ = f;
return (o__23009__auto__["toString"]).call(o__23009__auto__);
} else {
return "";
}
}catch (e24322){var _ = e24322;
return "";
}});
...
try{var o__23009__auto___24324 = t;
(o__23009__auto___24324["cljs$lang$ctorPrWriter"]).call(o__23009__auto___24324,t,writer);
}catch (e24323){var __24325 = e24323;
}
...
var char_code = (function (){var o__23009__auto__ = (new String(char$));
return (o__23009__auto__["charCodeAt"]).call(o__23009__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__23009__auto__ = String;
return (o__23009__auto__["fromCharCode"]).call(o__23009__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24326 = num_code;
switch (G__24326) {
case (1):
return (185);
...
var o__23009__auto__ = String;
return (o__23009__auto__["fromCharCode"]).call(o__23009__auto__,superscript_code);
});
/**
...
}catch (e24328){var _e__23016__auto__ = e24328;
return false;
}})())){
...
var vec__24329 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24329,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o24332 = temp__5455__auto__;
var temp__5455__auto____$1 = (o24332["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o24333 = temp__5455__auto____$1;
return (o24333["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4497__auto___24340 = arguments.length;
var i__4498__auto___24341 = (0);
while(true){
if((i__4498__auto___24341 < len__4497__auto___24340)){
args__4500__auto__.push((arguments[i__4498__auto___24341]));

var G__24342 = (i__4498__auto___24341 + (1));
i__4498__auto___24341 = G__24342;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24336){
var vec__24337 = p__24336;
var ns_detector = cljs.core.nth.call(null,vec__24337,(0),null);
...
var G__24343 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24344 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24343;
remaining_tokens = G__24344;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24334){
var G__24335 = cljs.core.first.call(null,seq24334);
var seq24334__$1 = cljs.core.next.call(null,seq24334);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__24335,seq24334__$1);
});
...
var vec__24348 = cljs.core.split_with.call(null,(function (p1__24347_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24347_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24348,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24348,(1),null);
...
var vec__24351 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24351,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24351,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__24354 = cljs.core.rest.call(null,remaining_tokens);
var G__24355 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__24354;
name_tokens = G__24355;
continue;
} else {
...
var vec__24358 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__24358,(0),null);
var arity = cljs.core.nth.call(null,vec__24358,(1),null);
var vec__24361 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__24361,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__24361,(1),null);
var vec__24364 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__24364,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__24364,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__24364,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__24364,(3),null);
...
var vec__24370 = result;
var munged_ns = cljs.core.nth.call(null,vec__24370,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__24370,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__24370,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__24370,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__24370,(4),null);
var arity = cljs.core.nth.call(null,vec__24370,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__24374 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__24374,(0),null);
var args = cljs.core.nth.call(null,vec__24374,(1),null);
var vec__24377 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__24377,(0),null);
var name = cljs.core.nth.call(null,vec__24377,(1),null);
...
var G__24380 = (arity + (1));
var G__24381 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24382){
var vec__24383 = p__24382;
var arity = cljs.core.nth.call(null,vec__24383,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__24383,(1),null);
...
return cljs.core.get.call(null,arities,p1__24386_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__24387_SHARP_);
...
var args__4500__auto__ = [];
var len__4497__auto___24394 = arguments.length;
var i__4498__auto___24395 = (0);
while(true){
if((i__4498__auto___24395 < len__4497__auto___24394)){
args__4500__auto__.push((arguments[i__4498__auto___24395]));

var G__24396 = (i__4498__auto___24395 + (1));
i__4498__auto___24395 = G__24396;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24390){
var vec__24391 = p__24390;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__24391,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24388){
var G__24389 = cljs.core.first.call(null,seq24388);
var seq24388__$1 = cljs.core.next.call(null,seq24388);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__24389,seq24388__$1);
});
...
var map__24399 = options;
var map__24399__$1 = ((((!((map__24399 == null)))?(((((map__24399.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__24399.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__24399):map__24399);
var include_ns_QMARK_ = cljs.core.get.call(null,map__24399__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__24399__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__24399__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__24399__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24400 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__24400,(0),null);
var fn_name = cljs.core.nth.call(null,vec__24400,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__24400,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__24400,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__24400,(4),null);
var arity = cljs.core.nth.call(null,vec__24400,(5),null);
...
var o__23009__auto__ = f;
return (o__23009__auto__["getBasis"]).call(o__23009__auto__);
});
/**
...
}catch (e24404){var _e__23016__auto__ = e24404;
...
var G__24405 = (obj[cljs.core.first.call(null,path)]);
var G__24406 = cljs.core.rest.call(null,path);
obj = G__24405;
path = G__24406;
continue;
} else {
...
return (function (accum,p__24407){
var vec__24408 = p__24407;
var bit = cljs.core.nth.call(null,vec__24408,(0),null);
var protocol = cljs.core.nth.call(null,vec__24408,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24411){
var vec__24412 = p__24411;
var ns = cljs.core.nth.call(null,vec__24412,(0),null);
var name = cljs.core.nth.call(null,vec__24412,(1),null);
var selector = cljs.core.nth.call(null,vec__24412,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__24417,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__24417,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__24417,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__24415_SHARP_){
return (obj[cljs.core.first.call(null,p1__24415_SHARP_)]);
});})(name,sorted_matches,vec__24417,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1521146634319
