...
var G__22588 = o;
(G__22588[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__22593){
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__22596){
...
var on_write = cljs.core.get.call(null,map__22597__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__22597,map__22597__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__22597,map__22597__$1,on_write))
);
} else {
...
reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__22602){
...
var synthetic_on_update = cljs.core.get.call(null,map__22603__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.call(null,map__22603__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
...
var G__22605 = jsprops;
(G__22605["defaultValue"] = value);

(G__22605["onChange"] = ((function (G__22605,v,value,on_change,on_change__$1,map__22603,map__22603__$1,synthetic_on_update,synthetic_on_change){
return (function (p1__22599_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change__$1,p1__22599_SHARP_);
});})(G__22605,v,value,on_change,on_change__$1,map__22603,map__22603__$1,synthetic_on_update,synthetic_on_change))
);
...
var vec__22609 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__22609,(0),null);
var id = cljs.core.nth.call(null,vec__22609,(1),null);
var class$ = cljs.core.nth.call(null,vec__22609,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___22613 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___22613 == null)){
} else {
var key_22614 = temp__5461__auto___22613;
...
reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__22617){
...
var synthetic_input = cljs.core.get.call(null,map__22618__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__22620 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__22620["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__22621 = wrapped;
(G__22621["syntheticInput"] = true);

return G__22621;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__22622 = wrapped__$1;
(G__22622["syntheticOnChange"] = on_change);

return G__22622;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__22623 = wrapped__$2;
(G__22623["syntheticOnUpdate"] = on_update);
...
var len__4497__auto___22629 = arguments.length;
var i__4498__auto___22630 = (0);
while(true){
if((i__4498__auto___22630 < len__4497__auto___22629)){
args__4500__auto__.push((arguments[i__4498__auto___22630]));

var G__22631 = (i__4498__auto___22630 + (1));
i__4498__auto___22630 = G__22631;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq22627){
var G__22628 = cljs.core.first.call(null,seq22627);
var seq22627__$1 = cljs.core.next.call(null,seq22627);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__22628,seq22627__$1);
});
...
break;
default:
var G__22634 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__22634;
continue;
...
var n__4376__auto___22636 = a.length;
var i_22637 = (0);
while(true){
if((i_22637 < n__4376__auto___22636)){
(a[i_22637] = reagent.impl.template.as_element.call(null,(a[i_22637])));
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___22639 = a.length;
var i_22640 = (0);
while(true){
if((i_22640 < n__4376__auto___22639)){
var val_22641 = (a[i_22640]);
if(((cljs.core.vector_QMARK_.call(null,val_22641)) && ((reagent.impl.template.key_from_vec.call(null,val_22641) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_22640] = reagent.impl.template.as_element.call(null,val_22641));
...
var ctx = ({});
var vec__22643 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__22643,(0),null);
var derefed = cljs.core.nth.call(null,vec__22643,(1),null);
...
var G__22646 = (cljs.core.count.call(null,argv) - first_child);
switch (G__22646) {
case (0):
...
break;
default:
return module$Users$jocrau$dev$workspaces$clojure_meetup$node_modules$react$index["default"].createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__22646){
...
//# sourceMappingURL=template.js.map?rel=1521146631684
