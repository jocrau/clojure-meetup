...
return cljs.core.swap_BANG_.call(null,tutorials.react_frontend.todo.todos,tutorials.react_frontend.todo.mmap,cljs.core.map,(function (p1__29675_SHARP_){
return cljs.core.assoc_in.call(null,p1__29675_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1),new cljs.core.Keyword(null,"done","done",-889844188)], null),v);
}));
});
tutorials.react_frontend.todo.clear_done = (function tutorials$react_frontend$todo$clear_done(){
return cljs.core.swap_BANG_.call(null,tutorials.react_frontend.todo.todos,tutorials.react_frontend.todo.mmap,cljs.core.remove,(function (p1__29676_SHARP_){
return cljs.core.get_in.call(null,p1__29676_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(1),new cljs.core.Keyword(null,"done","done",-889844188)], null));
}));
});
tutorials.react_frontend.todo.todo_input = (function tutorials$react_frontend$todo$todo_input(p__29679){
...
var title = cljs.core.get.call(null,map__29680__$1,new cljs.core.Keyword(null,"title","title",636505583));
var on_save = cljs.core.get.call(null,map__29680__$1,new cljs.core.Keyword(null,"on-save","on-save",1618176266));
var on_stop = cljs.core.get.call(null,map__29680__$1,new cljs.core.Keyword(null,"on-stop","on-stop",1520114515));
var val = reagent.core.atom.call(null,title);
var stop = ((function (val,map__29680,map__29680__$1,title,on_save,on_stop){
return (function (){
...
});})(val,map__29680,map__29680__$1,title,on_save,on_stop))
;
var save = ((function (val,stop,map__29680,map__29680__$1,title,on_save,on_stop){
return (function (){
...
});})(val,stop,map__29680,map__29680__$1,title,on_save,on_stop))
;
return ((function (val,stop,save,map__29680,map__29680__$1,title,on_save,on_stop){
return (function (p__29682){
var map__29683 = p__29682;
var map__29683__$1 = ((((!((map__29683 == null)))?(((((map__29683.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29683.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__29683):map__29683);
var id = cljs.core.get.call(null,map__29683__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var class$ = cljs.core.get.call(null,map__29683__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var placeholder = cljs.core.get.call(null,map__29683__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref.call(null,val),new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"class","class",-2030961996),class$,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),placeholder,new cljs.core.Keyword(null,"on-blur","on-blur",814300747),save,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (map__29683,map__29683__$1,id,class$,placeholder,val,stop,save,map__29680,map__29680__$1,title,on_save,on_stop){
return (function (p1__29677_SHARP_){
return cljs.core.reset_BANG_.call(null,val,p1__29677_SHARP_.target.value);
});})(map__29683,map__29683__$1,id,class$,placeholder,val,stop,save,map__29680,map__29680__$1,title,on_save,on_stop))
,new cljs.core.Keyword(null,"on-key-down","on-key-down",-1374733765),((function (map__29683,map__29683__$1,id,class$,placeholder,val,stop,save,map__29680,map__29680__$1,title,on_save,on_stop){
return (function (p1__29678_SHARP_){
var G__29685 = p1__29678_SHARP_.which;
switch (G__29685) {
case (13):
...
tutorials.react_frontend.todo.todo_edit = cljs.core.with_meta.call(null,tutorials.react_frontend.todo.todo_input,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),(function (p1__29687_SHARP_){
return reagent.core.dom_node.call(null,p1__29687_SHARP_).focus();
})], null));
tutorials.react_frontend.todo.todo_stats = (function tutorials$react_frontend$todo$todo_stats(p__29688){
...
var filt = cljs.core.get.call(null,map__29689__$1,new cljs.core.Keyword(null,"filt","filt",169229082));
var active = cljs.core.get.call(null,map__29689__$1,new cljs.core.Keyword(null,"active","active",1895962068));
var done = cljs.core.get.call(null,map__29689__$1,new cljs.core.Keyword(null,"done","done",-889844188));
var props_for = ((function (map__29689,map__29689__$1,filt,active,done){
return (function (name){
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),((cljs.core._EQ_.call(null,name,cljs.core.deref.call(null,filt)))?"selected":null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__29689,map__29689__$1,filt,active,done){
return (function (){
return cljs.core.reset_BANG_.call(null,filt,name);
});})(map__29689,map__29689__$1,filt,active,done))
], null);
});})(map__29689,map__29689__$1,filt,active,done))
;
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span#todo-count","span#todo-count",-1116128108),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"strong","strong",269529000),active], null)," ",(function (){var G__29691 = active;
switch (G__29691) {
case (1):
return "item";
...
var id = cljs.core.get.call(null,map__29695__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var done = cljs.core.get.call(null,map__29695__$1,new cljs.core.Keyword(null,"done","done",-889844188));
var title = cljs.core.get.call(null,map__29695__$1,new cljs.core.Keyword(null,"title","title",636505583));
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(done)?"completed ":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(cljs.core.deref.call(null,editing))?"editing":null))].join('')], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.view","div.view",-1680900976),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input.toggle","input.toggle",-519545942),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"checkbox",new cljs.core.Keyword(null,"checked","checked",-50955819),done,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (map__29695,map__29695__$1,id,done,title,editing){
return (function (){
return tutorials.react_frontend.todo.toggle.call(null,id);
});})(map__29695,map__29695__$1,id,done,title,editing))
], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-double-click","on-double-click",1434856980),((function (map__29695,map__29695__$1,id,done,title,editing){
return (function (){
return cljs.core.reset_BANG_.call(null,editing,true);
});})(map__29695,map__29695__$1,id,done,title,editing))
], null),title], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button.destroy","button.destroy",1044866871),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__29695,map__29695__$1,id,done,title,editing){
return (function (){
return tutorials.react_frontend.todo.delete$.call(null,id);
});})(map__29695,map__29695__$1,id,done,title,editing))
], null)], null)], null),(cljs.core.truth_(cljs.core.deref.call(null,editing))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tutorials.react_frontend.todo.todo_edit,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"class","class",-2030961996),"edit",new cljs.core.Keyword(null,"title","title",636505583),title,new cljs.core.Keyword(null,"on-save","on-save",1618176266),((function (map__29695,map__29695__$1,id,done,title,editing){
return (function (p1__29693_SHARP_){
return tutorials.react_frontend.todo.save.call(null,id,p1__29693_SHARP_);
});})(map__29695,map__29695__$1,id,done,title,editing))
,new cljs.core.Keyword(null,"on-stop","on-stop",1520114515),((function (map__29695,map__29695__$1,id,done,title,editing){
return (function (){
...
return (function tutorials$react_frontend$todo$todo_app_$_iter__29697(s__29698){
return (new cljs.core.LazySeq(null,((function (items,done,active,filt){
return (function (){
var s__29698__$1 = s__29698;
while(true){
var temp__5457__auto__ = cljs.core.seq.call(null,s__29698__$1);
if(temp__5457__auto__){
var s__29698__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__29698__$2)){
var c__4290__auto__ = cljs.core.chunk_first.call(null,s__29698__$2);
var size__4291__auto__ = cljs.core.count.call(null,c__4290__auto__);
var b__29700 = cljs.core.chunk_buffer.call(null,size__4291__auto__);
if((function (){var i__29699 = (0);
while(true){
if((i__29699 < size__4291__auto__)){
var todo = cljs.core._nth.call(null,c__4290__auto__,i__29699);
cljs.core.chunk_append.call(null,b__29700,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tutorials.react_frontend.todo.todo_item,todo], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(todo)], null)));

var G__29702 = (i__29699 + (1));
i__29699 = G__29702;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__29700),tutorials$react_frontend$todo$todo_app_$_iter__29697.call(null,cljs.core.chunk_rest.call(null,s__29698__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__29700),null);
}
} else {
var todo = cljs.core.first.call(null,s__29698__$2);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tutorials.react_frontend.todo.todo_item,todo], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(todo)], null)),tutorials$react_frontend$todo$todo_app_$_iter__29697.call(null,cljs.core.rest.call(null,s__29698__$2)));
}
} else {
return null;
}
...
;
return iter__4292__auto__.call(null,cljs.core.filter.call(null,(function (){var G__29701 = cljs.core.deref.call(null,filt);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29701__$1)].join('')));
...
//# sourceMappingURL=todo.js.map?rel=1521340656352
